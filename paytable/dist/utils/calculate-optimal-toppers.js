...
exports.calculateOptimalToppers = calculateOptimalToppers;
const share_based_paytable_1 = require("./../share-based-paytable");
function calculateOptimalToppers(totalPrizePool, ticketPrice, top10PercentPlaces, moneyBackTotal, inbetweenersMultiplier, decimalPlacesUsed) {
    ...
    while (left <= right) {
        ...
        const { share } = (0, share_based_paytable_1.getShareAmount)(mid);
